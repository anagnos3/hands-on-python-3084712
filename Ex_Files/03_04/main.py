...
#laureates_beginning_with_a = list(filter(lambda laureate: (laureate["name"][0] == 'a'), laureates))
laureates_beginning_with_a = [laureate for laureate in laureates if laureate["name"][0].lower() == 'a']
